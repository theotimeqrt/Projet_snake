...
int main(void){
    ...
    connectToServer("localhost", 3456, "Théotime") ;
    printf("connecté serveur\n") ;

    // -----------------------Récuperation des informations------------------------------------

    while(1){ // boucle pour enchainer les games
        ...
        waitForSnakeGame("TOURNAMENT EI", &gameName, &sizeX, &sizeY, &nbWalls); //attend retour partie
    ...
    } //fin while pour enchainer les parties
